...
/// Describes how raw media should be read when encrypting into the album.
enum MediaSource {
    case data(Data)
    case fileURL(URL)
}
...
/// Lightweight notification model published by `AlbumManager` to inform the UI
...
struct SecurePhoto: Identifiable, Codable {
    ...
    var albumAlbum: String?  // Custom album within the album
    var fileSize: Int64
    ...
    init(
        ...
        filename: String, dateTaken: Date? = nil, sourceAlbum: String? = nil, albumAlbum: String? = nil,
