...
/// Service responsible for importing assets from the Photo Library into the vault
class ImportService {
    private let progress: ImportProgress
    
    /// Closure type for hiding an asset. Matches VaultManager.hidePhoto signature components.
